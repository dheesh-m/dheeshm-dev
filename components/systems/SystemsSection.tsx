    ...
    <section id="skills" className="relative w-full py-20 md:py-28 overflow-hidden bg-transparent">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-8 sm:mb-12 text-center flex flex-col items-center justify-center max-w-3xl mx-auto">
          ...
          >
            <h2 className="text-[clamp(2.2rem,8vw,4.5rem)] font-light tracking-[-0.04em] leading-tight font-display mb-3 sm:mb-4 text-transparent bg-clip-text bg-gradient-to-r from-[#171A1F] via-[#334155] to-[#394E6E] dark:from-[#8A8A8A] dark:via-[#D1D5DB] dark:to-[#FFFFFF] whitespace-normal sm:whitespace-nowrap">
              Engineering Systems
            </h2>
            <p className="text-[#66717D] dark:text-gray-400 font-sans max-w-2xl text-sm sm:text-base md:text-lg leading-relaxed text-center">
