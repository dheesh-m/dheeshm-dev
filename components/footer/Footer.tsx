...
export default function Footer() {
  return (
    <footer id="contact" className="relative w-full flex flex-col items-center justify-center pt-32 pb-12 overflow-hidden min-h-[80vh] z-20">
      
      {/* Gradient Background / Flow */}
      <div className="absolute inset-0 pointer-events-none">
        {/* Soft, dark gradient flow */}
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-white/[0.015] to-[#060606]" />
        
        {/* Subtle white atmospheric glow at the very bottom (not too much white) */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center mt-8 flex-grow flex flex-col justify-center">
        <motion.div
        ...
        >
          <h2 className="text-[clamp(2.5rem,12vw,7.5rem)] font-bold tracking-[-0.04em] leading-[0.9] text-white mb-6 font-sans">
      ...
      <div className="relative z-10 mt-auto pt-16 text-[10px] md:text-xs font-mono tracking-widest text-[#666666] uppercase w-full text-center px-6">
